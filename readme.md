...
| 操作          | 耗时                                                         |
| ------------- | ------------------------------------------------------------ |
| Scatter       | $(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$  |
| Gather        | $(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$     |
| Broadcast     | $(p-1)(\alpha+n\beta)=(p-1)\alpha+ (p-1)n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$$(p-1)(\alpha+\frac np\beta)=(p-1)\alpha+\frac {p-1}p n\beta$    |
